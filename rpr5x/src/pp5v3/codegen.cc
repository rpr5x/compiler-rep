...
{
  OffsetToCurrentLocal = -8; 
  OffsetToCurrentGlobal = 0;
  OffsetToCurrentParam = 8; 
}
...
Location *CodeGenerator::GenTempVar()
{
  ...
  result = new Location(fpRelative, this->OffsetToCurrentLocal, temp); 
  this->OffsetToCurrentLocal -= 4;
