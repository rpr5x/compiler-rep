...
%type <expr>      Expr OptionalExpr Constant Call LValue
%type <exprList>  ExprList
%type <classDecl>     ClassDecl
%type <identifiers>   Extends Interface
%type <implements> Implements ImplementList
...
%left '+' '-'
%left '*' '/' '%'
%left '!' UMINUS T_Increment T_Decrement 
%left '(' T_This T_ReadInteger T_ReadLine T_New T_NewArray '.' '['
...
Implements :  T_Implements ImplementList {$$=$2; }
...
IfStmt    : T_If '(' Expr ')' Stmt             {$$ = new IfStmt($3, $5, NULL); } %prec "then"   
...
Expr       :  LValue '=' Expr                     {$$ = new AssignExpr($1, new Operator(@2, "="), $3);         }
           ...
           |  Expr '/' Expr                       {$$ = new ArithmeticExpr($1, new Operator(@2, "/"), $3);     }
           |  Expr '%' Expr                       {$$ = new ArithmeticExpr($1, new Operator(@2, "%"), $3);     }
           |  '-' Expr                            {$$ = new ArithmeticExpr(new Operator(@1, "-"), $2);         } %prec UMINUS
...
LValue     : T_Identifier                          {$$ = new FieldAccess(NULL, new Identifier(@1, $1));}
           ...
           | Expr '[' Expr ']'                     {$$ = new ArrayAccess(@3, $1, $3);                  }
;
